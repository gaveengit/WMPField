...
public class AddMrcServiceAdditionalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.add_mrcservice_additional);
    ...
    public void submitMrcService(View v) {
        ...
        MrcServiceModel mrcServiceModel = new MrcServiceModel(mrc_run_id, mrc_trap_id, service_id, currentDate, current_time, service_status);
        long flag = dbHandler.updateSingleMrcService(mrcServiceModel);
        Log.d("flag",String.valueOf(flag));
        if (flag != -1) {
            Toast.makeText(context, "MRC Service has been updated successfully.",
            ...
            Toast.makeText(context, "Failure in adding MRC service. Please try again..",
                    Toast.LENGTH_LONG).show();
            Intent intent = new Intent(context,MapsActivity.class);
            intent.putExtra("run_name", mrc_run_id);
            intent.putExtra("field_type", "mrc");
